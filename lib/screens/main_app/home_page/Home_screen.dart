                  ...
                  return Stack(
                    children: [
                      AnimatedPositioned(
                          ...
                          width: 280.w,
                          left:
                              Provider_home.is_side_menu_opened ? 0.w : -230.w,
                      ...
                      Transform(
                        ...
                        transform: Matrix4.identity()
                          ..setEntry(3, 2, 0.001)
                          ..rotateY(Provider_home.is_side_menu_opened
                              ? 1 - 30 * pi / 180
                              : 0),
                        child: Transform.translate(
                            offset: Offset(
                                Provider_home.is_side_menu_opened ? 230.w : 0.w,
                                0.h),
                            child: Transform.scale(
                                scale: Provider_home.is_side_menu_opened
                                    ? 0.72
                                    : 1,
                                child: ClipRRect(
                                  borderRadius: BorderRadius.all(
                                      Radius.circular(
                                          Provider_home.is_side_menu_opened
                                              ? 40
                                              : 0)),
                                  child: const Home(),
                                ))),
