...
class Add_container extends StatelessWidget {
  const Add_container({
    Key? key,
    required this.isitadd, required this.size,
  }) : super(key: key);
  final bool isitadd;
  final int size ;
      ...
      children: [
        ...
        Row(
          children: [
            ...
            Consumer<Provider_numberofitems>(builder: (context, Provider_numberofitems, child) {
              return Stack(
                ...
                activeColor: KPrimarycolor,
                  ...
                  if (isitpressed) GestureDetector(
                    onTap: () {
                      setState(() {
                        group = 0 ;
                        isitpressed =false ;
